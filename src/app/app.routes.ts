...
export const routes: Routes = [
    ...
    { path: 'matches/:id/h2h', loadComponent: () => import('./pages/match-h2h-builder/match-h2h-builder.component').then(mod => mod.MatchH2hBuilderComponent) },
    { path: 'matches/:id/h2hrun', loadComponent: () => import('./pages/match-h2h-manager/match-h2h-manager.component').then(mod => mod.MatchH2hManagerComponent) },
    ...
    { path: 'competitions/:competitionId/matches/:id/h2h', loadComponent: () => import('./pages/match-h2h-builder/match-h2h-builder.component').then(mod => mod.MatchH2hBuilderComponent) },
    { path: 'competitions/:competitionId/matches/:id/h2hrun', loadComponent: () => import('./pages/match-h2h-manager/match-h2h-manager.component').then(mod => mod.MatchH2hManagerComponent) },
